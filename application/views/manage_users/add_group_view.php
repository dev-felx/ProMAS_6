...
<div id='' class='container-fluid'>
    ...
    <div class=' text-info row'>
        <div class="">
         ...
         <?php    } else{ ?>
            <h5 class='pull-left'>To Register <?php echo ucfirst($user); ?>s using a file,<a href='<?php echo site_url(); ?>/manage_users/add_group/download/<?php echo $user; ?>'><b> Click here first to download a Template file</b>,</a> then you can upload a new file</h5>
         <?php } ?>
            <div class='pull-right '>
            <button data-toggle="modal" href="#upload_file_modal" class="btn btn-success"  role="button" >Upload a new file</button>
            <a onclick="return confirm('Are you sure you want to delete all files?')" href="<?php echo site_url(); ?>/manage_users/add_group/delete_all_files/<?php echo $user; ?>" type="button" class="btn btn-danger push_right_bit " >Delete all Files</a>
            </div>
        </div>
    </div>
        <div class="row">
